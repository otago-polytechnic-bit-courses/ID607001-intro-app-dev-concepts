...
\texbf{Solution 1:} This is an okay solution, but we can limit the size of our \texbf{stack}. Also, there is an absence of error checking, in particular, when popping from the \texbf{stack}.
