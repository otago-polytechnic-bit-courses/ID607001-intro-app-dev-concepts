...
This is an okay solution, but we can limit the size of our \texbf{stack}. Also, there is an absence of error checking, in particular, when pushing \& popping to \& from the \texbf{stack}.
  ...
  <?php
      interface App {
       ...
       class Facebook implements App {
          ...
          public function login() {
              echo "Logged in with the email - $this->email.";
          }

          public function register() {
              echo "Registered with the email and username - $this->email and $this->username.";
          }
      ...
      $fb_user = new Facebook("john.doe@gmail.com", "P@ssw0rd123", "john.doe");
