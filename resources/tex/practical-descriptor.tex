...
In this \textbf{individual} assessment, you will you test the \textbf{Node.js REST API} you created in \textbf{Project 1: Node.js REST API}. In addition, marks will be allocated for code elegance, documentation \& \textbf{Git} usage.
