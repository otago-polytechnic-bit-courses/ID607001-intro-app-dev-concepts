...
\begin{itemize}
	...
	\item User-interface tests with \textbf{Cypress} that ensures the register, login \& logout functionality is working as expected. You \textbf{need} to declare a \textbf{npm} script in your application's \textbf{package.json} file that automates this process.
\end{itemize}
