...
\begin{itemize}
	...
	\item CRUD
	      \begin{itemize}
	      	...
	      	\item \hl{\textbf{Independent Research:}} View \textbf{REST API data} in a table using an id. For example, \textbf{/institutions/1} would return \textbf{REST API data} for that specific \textbf{Institutions} object.
	      	...
	      	\item \hl{\textbf{Independent Research:}} Incorrectly formatted form field values handled gracefully using validation error messages, i.e., \textbf{first name} form field is required.
	      \end{itemize}
	...
	\item User-interface \textbf{Cypress} tests that ensures the register, login \& logout functionality is working as expected. You \textbf{need} to declare a \textbf{npm} script in your application's \textbf{package.json} file that automates this process.
\end{itemize}
...
\begin{itemize}
	...
	\item Provide the following in your repository \textbf{README.md} file:
		...
		\item How do you run the user-interface \textbf{Cypress} tests?
