...
\section*{Exemplar}
You can find an exemplar here - \small\href{https://intro-app-dev-react-app.herokuapp.com}{https://intro-app-dev-react-app.herokuapp.com}
...
\begin{itemize}
    ...
    \item \textbf{Independent Research:} Code files are formatted using \textbf{Prettier}. You \textbf{must} declare a \textbf{npm} script in your application's \textbf{package.json} file which automates this process. Rules include:
    \begin{itemize}
