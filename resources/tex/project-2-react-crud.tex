	...
	\item Your \textbf{Git commit messages} should:
	      \begin{itemize}
	      	...
	      	\item Be formatted using the naming conventions outlined in the following:
	      	      ...
	      	      \end{itemize} 
	      \end{itemize}
	\item At least \textbf{seven} feature branches for the \textbf{independent research} functionality. \textbf{Note:} It excludes the \textbf{master} or \textbf{main} branch.
	      \begin{itemize}
