...
\begin{itemize}
    \item You will deploy the API given to you in the \textbf{Practical: REST API Testing Research} assessment to \textbf{Heroku}.
    \item Use the following resource as a starter for the \textbf{CRUD} functionality - \href{https://github.com/olinations/crud-starter-frontend-hooks}{https://github.com/olinations/crud-starter-frontend-hooks}
