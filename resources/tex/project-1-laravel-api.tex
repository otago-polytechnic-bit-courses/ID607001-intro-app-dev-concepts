...
\begin{itemize}
    ...
    \item \textbf{Independent Research:} For updating \& deleting, if the child table has a foreign key, you must use an on cascade update \& an on cascade delete. For example, if data in the parent table is updated, then data in the child/children table is updated as well.
  \end{itemize}
