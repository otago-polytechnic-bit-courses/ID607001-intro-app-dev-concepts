...
\begin{itemize}
	...
	\begin{itemize}
		\item Create \textbf{example.env} file containing all of the application's environment variables' key. It is for the development environment.
...
\begin{itemize}
	...
	\begin{itemize}
		\item You \textbf{should} provide an example for each route. 
