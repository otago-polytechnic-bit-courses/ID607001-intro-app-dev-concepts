...
\begin{itemize}
	...
	\item \textbf{Independent Research:} Return an appropriate message if a query does not return any \textbf{API data}.
	...
	\item \textbf{Independent Research:} Paginate the \textbf{REST API data} so that 25 records are displayed per page.
...
\begin{itemize}
  ...
  \item Sufficient modularity, i.e., reusable base URL.
	...
	\item \textbf{Independent Research:} Code files are formatted using \textbf{Prettier}. You \textbf{need} to declare a \textbf{npm} script in your application's \textbf{package.json} file which automates this process. Rules \textbf{must} include:
	      \begin{itemize}
