...
\begin{itemize}
	...
	\item \textbf{Five} \textbf{collections} containing at least \textbf{three fields} of data which you can interact with. \textbf{Note:} It includes a \textbf{Users collection}.
	\item \hl{\textbf{Independent Research:}} The \textbf{Users collection} must contain the following fields - \textbf{first\_name}, \textbf{last\_name}, \textbf{email} \& \textbf{password}. The \textbf{password} is salted and hashed.
