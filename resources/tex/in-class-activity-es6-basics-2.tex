...
\lfoot{In-Class Activity: ES6 Basics 2\\Version 2, Semester Two, 2022}
\rfoot{\thepage}
...
For each element in \textbf{nums}, calculate its power of two \& return as an \textbf{array} using the \textbf{map} function.
...
For each element in \textbf{temps}, convert its value from fahrenheit to celsius \& return as an \textbf{array} using the \textbf{map} function. Round each value to the nearest two decimal places using the \textbf{toFixed} function.
...
Using the \textbf{readFile} function, read \textbf{nursery-rhyme.txt} located in the \textbf{formative assessments} directory. For each word in \textbf{nursery-rhyme.txt}, convert it to \textbf{lowercase} using the \textbf{map} function. 
...
Using the \textbf{readFile} function, read \textbf{users.json} located in the \textbf{formative assessments} directory. Using the \textbf{filter} function, return \textbf{users} who are \textbf{Senior Lecturers}.
