...
\begin{itemize}
    ...
    \item \textbf{API test files} are stored a directory called \textbf{test} located in the root directory. Each file has the file extension - \textbf{.test.js}
    ...
    \item \textbf{Prettier}, \textbf{Chai} \& \textbf{Mocha} are installed as development dependencies.
