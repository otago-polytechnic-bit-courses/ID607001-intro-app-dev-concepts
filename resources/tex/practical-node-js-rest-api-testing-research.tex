...
\textbf{Note:} The given \textbf{Node.js REST API} application is located in the \textbf{course materials repository > assessments}.

application called \textbf{practical-node-js-rest-api-example} in the \textbf{assessments} directory in the course materials repository.
...
\begin{itemize}
    ...
    \end{itemize}
    \item Application's environment variables are stored in a \textbf{.env.testing} file.
    \begin{itemize}
      \item Create a \textbf{example.env.testing} file containing all of the application's environment variables' key. It is for the testing environment.
