...
\begin{itemize}
    ...
    \item At least \textbf{50 API tests} verifying the correctness of the following:
          ...
          \end{itemize}
    \item \textbf{Code coverage } using \textbf{nyc}. 
\end{itemize}
...
\begin{itemize}
    ...
    \item Test files are stored a directory called \textbf{tests} located in the root directory \& have the extension \textbf{.test.js}.
    ...
    \end{itemize}
    \item Declare a \textbf{npm} script in your application's \textbf{package.json} file that runs the \textbf{API test} \& \textbf{code coverage} sequentially.
    \item \textbf{Prettier}, \textbf{Chai}, \textbf{Mocha} \& \textbf{nyc} are installed as development dependencies.
...
\begin{itemize}
    ...
    \begin{itemize} 
      ...
      \item How do you run the \textbf{code coverage}?
