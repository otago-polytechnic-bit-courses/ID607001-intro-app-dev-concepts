...
| Band | Marks   | Criteria                                                                                                                                                                                                                                                                                      |
| ---- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A    | 4.5-5   | Complete and comprehensive endpoint documentation in clear table format. All required information present for every endpoint: HTTP method, URL, description, authentication requirements, RBAC details and all parameter types. Follows RESTful conventions. Well-organised and professional. |
...
| Band | Marks   | Criteria                                                                                                                                                                                                                 |
| ---- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| A    | 0.9-1   | Filtering, sorting and pagination fully implemented on all read all operations. Multiple filter criteria supported. Flexible sorting options. Proper pagination with page sise controls. Query parameters well-designed. |
