...
| Band | Marks | Criteria                                                                                                                                                                                                                                                                    |
| ---- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A    | 2.4-3   | Excellent project structure with clear separation of concerns. Presentation, service and data access layers properly separated. Code is highly modular with well-defined, reusable functions and modules. Easy to navigate and understand. Follows industry best practices. |
