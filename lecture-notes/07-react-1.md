...
Yes. You will use **React** in **Intermediate Application Development**, **Advanced Application Development** and **Mobile Application Development**. If you choose to do **Web** or **Mobile** in **Studio 5/6**, you will use **React** or **React Native**.
