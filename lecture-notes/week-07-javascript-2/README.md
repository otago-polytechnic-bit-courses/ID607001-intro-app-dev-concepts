...
Link to the lecture video: [Week 07 Lecture Video]()
...
Open your repository in **Visual Studio Code**. Check out to the **Week 07** branch using the following command:

```bash
git checkout week-07-javascript-2
```
