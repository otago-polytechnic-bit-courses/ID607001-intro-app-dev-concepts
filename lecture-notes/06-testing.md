...
- `.post(${BASE_URL}/institutions)`: Specifies that a POST request should be made to the /institutions endpoint. BASE_URL is a variable that should hold the base URL of the API (e.g., http://localhost:3000).
