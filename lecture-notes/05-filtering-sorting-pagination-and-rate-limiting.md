...
Here is an example **GET** request that returns all institutions that have the `name` **Otago Polytechnic**: `http://localhost:3000/api/institutions?name=University`
...
Here is an example **GET** request that returns all institutions that have the `name` **Otago Polytechnic**, sorted by **name** in **ascending** order: `http://localhost:3000/api/institutions?name=University&sortBy=name&sortOrder=asc`
...
Here is an example **GET** request that returns the first 15 institutions that have the `name` **Otago Polytechnic**, sorted by **name** in **ascending** order: `http://localhost:3000/api/institutions?name=University&sortBy=name&sortOrder=asc&amount=15&page=1`
