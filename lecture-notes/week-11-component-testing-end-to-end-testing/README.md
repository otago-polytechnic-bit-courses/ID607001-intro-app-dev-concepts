...
Open your repository in **Visual Studio Code**. Switch to the **Week 11** branch using the following command:

```bash
git checkout -b week-11-component-testing-end-to-end-testing
```
