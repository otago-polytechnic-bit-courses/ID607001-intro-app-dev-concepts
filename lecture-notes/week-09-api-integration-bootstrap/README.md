# Week 09 - API Integration and Bootstrap

## Navigation

| | Link |
| --- | --- |
| Previous | [Week 08 - Vite, SvelteKit and Deployment](../week-08-vite-sveltekit-deployment/README.md) |
| Code Example | [Code Example](code-example) |
| Next | [Week 10 - GitHub Actions, Performance and UI/UX Design](../week-10-github-actions-performance-ui-ux-design/README.md) |
...
```bash
git checkout -b w09-api-integration-bootstrap
```

Create a new SvelteKit application called `week-09-api-integration-bootstrap`.
...
```
week-09-api-integration-bootstrap/
├── src/
│   ├── app.d.ts
│   ├── app.html
│   ├── lib/
