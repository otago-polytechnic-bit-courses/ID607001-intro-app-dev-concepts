# Module 04 - Backend: PostgreSQL, Prisma and Real CRUD

## Navigation

|          |                                                                                         |
| -------- | --------------------------------------------------------------------------------------- |
| Previous | [Module 03 - Frontend: SvelteKit Basics](../module-03-frontend-sveltekit/README.md)     |
| Next     | [Module 05 - Frontend: Create, Update and Delete](../module-05-frontend-crud/README.md) |
...
You will replace the hard-coded institution data with a real PostgreSQL database. By the end:

- All five CRUD operations work against a real database
- Institutions survive server restarts
- Migrations track every change to your database structure
- A seed script fills the database with sample data

Module 05 will update the frontend to use these new write endpoints.
...
Module 05 updates the SvelteKit frontend to consume these real CRUD endpoints - adding forms to create, edit, and delete institutions. The page structure you built in Module 03 stays the same; you are extending it.
