...
Open your repository in **Visual Studio Code**. Check out to the **Week 04** branch using the following command:

```bash
git checkout week-04-content-negotiation-relationships-n-layer-architecture
```
