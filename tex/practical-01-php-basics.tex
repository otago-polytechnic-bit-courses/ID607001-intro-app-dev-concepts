...
In this assessment, you will solve five coding problems using \textbf{PHP} in \textbf{Repl.it}. 
...
Declare two variables called name \& age with the values John \& 55. Use the two variables to display the expected output.
