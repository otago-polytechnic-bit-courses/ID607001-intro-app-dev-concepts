...
Write a function called \textbf{is\_five\_letters} which accepts an \textbf{array} of \textbf{strings}. In the function block, return the words that are exactly \textbf{five} letters.
...
Write a function called \textbf{remove\_one} which removes all occurrences of the number \textbf{1 (one)} in an \textbf{array}. 
...
It is my birthday in a couple months, so you will need to save your pennies to buy me a present. Write a function called \textbf{it\_is\_my\_birthday} that accepts a \textbf{DateTime} object \& returns \textbf{true} if it is the 8th of April, otherwise return \textbf{false}.

\begin{verbatim}
  <?php  
  // Write your solution here

  it_is_my_birthday(new DateTime("1995-04-08"))
  it_is_my_birthday(new DateTime("2015-12-13"))
