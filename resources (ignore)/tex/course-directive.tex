...
\title{Course Directive\\ID607001: Introductory Application Development Concepts\\Semester Two, 2024}
\date{}
\maketitle 
...
\begin{tabular}{ll}
	...
	Timetable:    & Rōpū Kōwhai: Wednesday 3.00 PM D207 and Friday 1.00 PM D207   \\
\end{tabular} 
...
\begin{tabular}{|c|c|c|}
	...
	2/Rua            & \multicolumn{2}{c|}{TypeScript, Express, HTTP Methods, HTTP Status Codes and HTTP Headers}                    \\ \hline
	3/Toru           & \multicolumn{2}{c|}{Render, PostgreSQL, ORM, JSDocs and Swagger} \\ \hline 
	4/Whā            & \multicolumn{2}{c|}{API Versioning, Content Negotiation, Relationships and Repository Pattern}                               \\ \hline
	5/Rima           & \multicolumn{2}{c|}{Validation, Filtering, Sorting and Pagination}                                                \\ \hline
	6/Ono            & \multicolumn{2}{c|}{Authentication, Max Retry, Jail and Role-Based Access Control}                                                   \\ \hline
	7/Whitu          &  \multicolumn{2}{c|}{HTTP Caching, Compression, Rate Limiting and Securing HTTP Headers}                            \\ \hline

	8/Waru   & \multicolumn{2}{c|}{Database Seeding and API Testing}                                                  \\ \hline
	9/Iwa            & \multicolumn{2}{c|}{ERD Generation and README.md Setup}                                                                 \\ \hline
	10/Tekau         & \multicolumn{2}{c|}{REST API Integration with Frontend Application}                                                                 \\ \hline
