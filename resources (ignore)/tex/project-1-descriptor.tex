...
\lfoot{Project 1: Node.js REST API\\Version 4, Semester Two, 2023}
\rfoot{\thepage}  
...
\begin{itemize} 
	...
	\begin{itemize}
		...
		\item The \textbf{index route}, i.e., \textbf{https://localhost:3000/api/} must display all existing \textbf{routes}. \textbf{Note:} This can be hardcoded.
