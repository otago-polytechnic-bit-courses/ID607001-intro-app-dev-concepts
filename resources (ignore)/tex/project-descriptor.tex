...
\begin{itemize} 
	...
	\item \textbf{CRUD Application:}
		...
		\item Request \textbf{REST API} data from \textbf{four} \textbf{API} resource groups using \textbf{Axios}.
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{REST API} - \href{https://id607001-graysono-wbnj.onrender.com}{https://id607001-graysono-wbnj.onrender.com}
		\item \textbf{CRUD Application} - In \textbf{assessments $>$ project} directory of the \textbf{course materials} repository.
	\end{itemize}
