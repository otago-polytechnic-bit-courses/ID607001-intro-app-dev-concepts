...
\begin{itemize} 
	...
	\item \textbf{Scripts:}
	\begin{itemize}
		\item Run your \textbf{REST API} and \textbf{React CRUD Application} locally.
...
\subsection*{Code Elegance - Learning Outcome 1 (55\%)}
\begin{itemize}
...
\begin{itemize}
	...
	\item A URL to your \textbf{REST API} as a \textbf{web service} on \textbf{Render}.
	  ...
	  \item How do you run your \textbf{REST API} and \textbf{React CRUD Application} locally?
...
\begin{itemize}
    ...
    \item You need to show the course lecturer the initial \textbf{GitHub} project board before you start your development work.
\end{itemize} 
\end{document}