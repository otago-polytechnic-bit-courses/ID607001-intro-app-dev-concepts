...
\lfoot{Project\\Version 5, Semester One, 2024}
\rfoot{\thepage}  
...
\begin{tabular}{|c|c|c|c|}
	...
	\small Practical & \small 20\%        & \small 08-10-2023 (Sunday at 04.59 PM)   & \small 1                   \\ \hline
	\small Project                 & \small 80\%        & \small 15-09-2023 (Friday at 04.59 PM) \small  & \small 1                   \\ \hline
\end{tabular}

\section*{Conditions of Assessment}
You will complete majority of this assessment during your learner-managed time. However, there will be time to discuss the requirements and your assessment progress during the teaching sessions. This assessment will need to be completed by \textbf{Friday, 15 September 2023 at 8.59 AM}.
...
You will need to submit a \textbf{full-stack application} and \textbf{documentation} that meet the following requirements: 

\subsection*{Functionality - Learning Outcome 1 (65\%)}
\begin{itemize} 
	\item \textbf{REST API (30\%):}
	\begin{itemize}
		\item Developed using \textbf{Node.js}.
		\item Can run locally and in production without modification.
		\item \textbf{Seven} \textbf{models}. Each containing a \textbf{minimum} of \textbf{three} \textbf{fields} excluding the \textbf{id}, \textbf{createdAt} and \textbf{updatedAt} \textbf{fields}.
	...
	\item \textbf{React CRUD Application (30\%):}
		\begin{itemize}
		\item Request \textbf{REST API} data from \textbf{seven} \textbf{API} resource groups using \textbf{Axios} and implement the following \textbf{CRUD} functionality:
		\begin{itemize}
			\item Create new data via a form. 
			\item View data in a table.
			\item Update data via a form. 
			\item Delete  data via a button. Prompt the user for deletion. You \textbf{can} use the in-built \textbf{confirm() JavaScript} function. 
	...
	\begin{itemize}
		\item Run your \textbf{REST API} and \textbf{React Application} locally.
...
\begin{itemize}
	...
	\item Appropriate naming of files, variables, functions, resource groups and components.
...
\begin{itemize}
    ...
    \begin{itemize} 
		...
		\item How do you run your \textbf{REST API} and \textbf{React Application} locally?
