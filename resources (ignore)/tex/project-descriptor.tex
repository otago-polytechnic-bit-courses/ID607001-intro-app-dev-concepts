...
In this \textbf{individual} assessment, you will develop a \textbf{REST API} using \textbf{Express} and \textbf{Node.js}, and deploy it as a \textbf{web service} on \textbf{Render}. In development, your data will be stored in a \textbf{PostgreSQL} database on \textbf{Docker} and in production, your data will be stored in a \textbf{PostgreSQL} database on \textbf{Render}.\\
...
\begin{itemize} 
	\item \textbf{Your choice REST API (25\%):}
	\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \textbf{Role} - BASIC and ADMIN.
		...
		\begin{itemize}
			\item Can not play if quiz has not started or has ended.
	...
	\begin{itemize}
		...
		\item Store their data in a \textbf{PostgreSQL} database on \textbf{Render}. \textbf{Note:} You may have to use the same database for both \textbf{REST API}.
