...
\lfoot{Practical: Node.js REST API Testing\\Version 4, Semester One, 2023}
\rfoot{\thepage}
...
\begin{itemize}
  \item \textbf{Testing:}
	...
	\end{itemize}
	\item \textbf{Scripts:}
  In your \textbf{package.json} file, you must have the following script to:
	\begin{itemize}
    \item Seed the database with \textbf{Prisma}.
		\item Run \textbf{API} tests using \textbf{Mocha}.
	\end{itemize}
\end{itemize}
